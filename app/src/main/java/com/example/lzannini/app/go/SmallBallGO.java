...
public class SmallBallGO extends GameObject {
    ...
    public SmallBallGO(GameWorld gw, float x, float y) {
        super(gw);
        INSTANCE_COUNT++;
        ...
        bodyDef.setLinearVelocity(new Vec2(1f, 1f));

        this.body = gw.getWorld().createBody(bodyDef);
        this.body.setSleepingAllowed(false);
        this.name = "SmallBall" + INSTANCE_COUNT;
